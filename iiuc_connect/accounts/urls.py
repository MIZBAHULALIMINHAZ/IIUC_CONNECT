...
from accounts.views import DepartmentCreateAPIView, DepartmentListAPIView, InactiveUsersAPIView, RegisterAPIView, LoginAPIView, ResendOTPAPIView, VerifyOTPAPIView, ProfileAPIView
